        ...
        <div class="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
            ...
            <div class="grid grid-cols-1 gap-4 lg:col-span-2">
                    ...
                    <div class="bg-white overflow-hidden shadow">
                            ...
                            <div class="sm:flex sm:items-center sm:justify-between">
                                <div class="sm:flex sm:space-x-5">
                                    ...
                                    <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                                        ...
                                        <p class="text-xl font-bold text-gray-900 sm:text-2xl">Man Wing Fai</p>
                                        <p class="text-sm font-medium text-gray-600">Web Master</p>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="px-6 py-5 text-sm font-medium text-center">
                                ...
                                <span class="text-gray-600">SEO Item</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section aria-labelledby="quick-links-title">
                    <div
                        class="bg-gray-200 text-black overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:grid-cols-2 sm:gap-px">
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <section aria-labelledby="recent-hires-title">
                    <div class="bg-white overflow-hidden shadow">
                        <div class="p-6">
                            <h2 class="text-base font-medium text-gray-900" id="recent-hires-title">Statistics</h2>
                            <div class="flow-root mt-6">
                                <div class="relative bg-white py-2 overflow-hidden">
                                    <dt>
                ...
                <section aria-labelledby="announcements-title">
                    <div class="bg-white overflow-hidden shadow">
                        <div class="p-6">
                            <h2 class="text-base font-medium text-gray-900" id="announcements-title">Contacts & Requests</h2>
                            <div class="flow-root mt-6">
